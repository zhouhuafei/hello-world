    ...
    function (t, e, r) {
      ...
      o(l.prototype),
        ...
        (l.prototype.ack = function (t) {
          ...
          return function () {
            if (!r) {
              ...
              var o = i(arguments)
              u('sending ack %j', o),
                e.packet({ type: f(o) ? n.BINARY_ACK : n.ACK, id: t, data: o })
            }
          }
        }),
        ...
        (l.prototype.close = l.prototype.disconnect = function () {
          return (
            this.connected &&
              (u('performing disconnect (%s)', this.nsp), this.packet({ type: n.DISCONNECT })),
            this.destroy(),
            ...
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((s = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  (e += s + h >= 1 ? p / u : p * Math.pow(2, 1 - h)) * u >= 2 && (s++, (u /= 2)),
                  s + h >= f
                    ? ((a = 0), (s = f))
                    : s + h >= 1
        ...
        (e.toByteArray = function (t) {
          for (
            ...
            (e =
              ...
              (a[u++] = 255 & e)
          2 === s &&
            ((e = (o[t.charCodeAt(h)] << 2) | (o[t.charCodeAt(h + 1)] >> 4)), (a[u++] = 255 & e))
          1 === s &&
            ((e =
              (o[t.charCodeAt(h)] << 10) |
      ...
      ;(function (e) {
        var n = r(2),
          ...
          i =
            ...
            ('undefined' != typeof Blob && '[object BlobConstructor]' === o.call(Blob)),
          s =
            'function' == typeof File ||
            ('undefined' != typeof File && '[object FileConstructor]' === o.call(File))
          ...
          function (t, e, r) {
            ;(function (t) {
              ...
              ;(e.encodePacket = function (r, n, o, i) {
                ...
                return (
                  void 0 !== r.data &&
                    (a += o ? u.encode(String(r.data), { strict: !1 }) : String(r.data)),
                  i('' + a)
                )
              }),
                (e.encodeBase64Packet = function (r, n) {
                  ...
                  try {
                    ...
                    for (
                      var a = new Uint8Array(r.data), u = new Array(a.length), c = 0;
                      c < a.length;
                      c++
                    )
                      u[c] = a[c]
                ...
                (e.decodePayload = function (t, r, n) {
                  ...
                  for (var i, s, a = '', u = 0, c = t.length; u < c; u++) {
                    ...
                    if (':' === f) {
                      ...
                      if (s.length) {
                        if (
                          ((o = e.decodePacket(s, r, !1)), d.type === o.type && d.data === o.data)
                        )
                          return n(d, 0, 1)
                  ...
                  g(
                    ...
                    function (t, e) {
                      var n = e.reduce(function (t, e) {
                          ...
                          return (
                            t +
                            (r = 'string' == typeof e ? e.length : e.byteLength).toString().length +
                            r +
                            2
                          )
                        }, 0),
                ...
                (e.decodePayloadAsBinary = function (t, r, n) {
                  ...
                  for (var o = t, i = []; o.byteLength > 0; ) {
                    for (
                      var a = new Uint8Array(o), u = 0 === a[0], c = '', f = 1;
                      255 !== a[f];
                      f++
                    ) {
            ...
            ;(t.exports = r),
              ...
              (r.prototype.emit = function (t) {
                ...
                if (n(r))
                  ...
                  for (
                    a = Array.prototype.slice.call(arguments, 1), s = (c = r.slice()).length, u = 0;
                    u < s;
                    u++
                  )
                    c[u].apply(this, a)
            ...
            class a extends n {
              ...
              send(t) {
                i('send data: ', t, this.readyState),
                  this.readyState === a.OPEN && this._socket.send({ data: t })
              }
              close(t, e) {
                i('close socket: ', t, e),
                  (this.readyState = a.CLOSING),
                  this._socket.close({ code: t, reason: e })
              }
            }
            s.forEach((t, e) => {
              a[s[e]] = e
            ...
            ;(function (t, n) {
              ...
              /*! https://mths.be/utf8js v2.1.2 by @mathias */ !(function (i) {
                ...
                function d(t, e) {
                  ...
                  return (
                    0 == (4294965248 & t)
                      ? (r = f(((t >> 6) & 31) | 192))
                      : 0 == (4294901760 & t)
                      ? (p(t, e) || (t = 65533), (r = f(((t >> 12) & 15) | 224)), (r += l(t, 6)))
                      : 0 == (4292870144 & t) &&
                        ((r = f(((t >> 18) & 7) | 240)), (r += l(t, 12)), (r += l(t, 6))),
                    (r += f((63 & t) | 128))
                  )
                }
                function y() {
                ...
                var v = {
                  ...
                  encode: function (t, e) {
                    for (
                      var r = !1 !== (e = e || {}).strict, n = h(t), o = n.length, i = -1, s = '';
                      ++i < o;
          ...
          function (t, e, r) {
            ...
            ;(function (t) {
              ...
              ;(u.prototype.slice = function (t, e) {
                ...
                (u.prototype.readInt8 = function (t, e) {
                  return (
                    e || x(t, 1, this.length), 128 & this[t] ? -1 * (255 - this[t] + 1) : this[t]
                  )
                }),
                (u.prototype.readInt16LE = function (t, e) {
                  e || x(t, 2, this.length)
            ...
            ;(function (e) {
              ...
              function f(t, r) {
                ...
                ;(r = r || {}),
                  ...
                  (this.port =
                    r.port ||
                    (e.location && location.port ? location.port : this.secure ? 443 : 80)),
                  (this.query = r.query || {}),
        ...
        ;(e.deconstructPacket = function (t) {
          ...
          (e.removeBlobs = function (t, e) {
            ...
            !(function t(u, c, f) {
              ...
              } else if (n(u)) for (var p = 0; p < u.length; p++) t(u[p], p, u)
              else if ('object' == typeof u && !o(u)) for (var l in u) t(u[l], l, u)
            })(i),
              r || e(i)
          })
      }.call(this, r(1)))
      ...
      function u(t, e) {
        ...
        return (
          e.forceNew || e['force new connection'] || !1 === e.multiplex || h
            ...
            : (a[c] || (s('new io instance for %s', u), (a[c] = i(u, e))), (r = a[c])),
